# agentconnectors <a href="https://discord.gg/qetWd7J9De"><img style="float: right" src="https://dcbadge.vercel.app/api/server/qetWd7J9De" alt=""></a>

Simple file management and serving for agents

<img src="resources/image.jpg">

[![Lint and Test](https://github.com/AutonomousResearchGroup/agentconnectors/actions/workflows/test.yml/badge.svg)](https://github.com/AutonomousResearchGroup/agentconnectors/actions/workflows/test.yml)
[![PyPI version](https://badge.fury.io/py/agentconnectors.svg)](https://badge.fury.io/py/agentconnectors)

# Installation

```bash
pip install agentconnectors
```
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("agentconnectors:start_server", host="0.0.0.0", port=int(os.getenv("PORT", 8000)))
```
...
```python
from agentconnectors import get_file
...
```python
from agentconnectors import add_file
...
```python
from agentconnectors import start_server
...
```python
from agentconnectors import get_server
...
```python
from agentconnectors import set_storage_path
...
```python
from agentconnectors import remove_file
...
```python
from agentconnectors import update_file
...
```python
from agentconnectors import list_files
